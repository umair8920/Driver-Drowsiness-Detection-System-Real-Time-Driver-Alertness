...
const firebaseConfig = {
  apiKey: "AIzaSyAnLOr7KV5AoUkD86zSk5dKqKL4wftvcjs",
  authDomain: "driverdrowsinessdetectio-fe3db.firebaseapp.com",
  projectId: "driverdrowsinessdetectio-fe3db",
  storageBucket: "driverdrowsinessdetectio-fe3db.appspot.com",
  messagingSenderId: "328159624974",
  appId: "1:328159624974:web:d2712aec4aae2ab9ace15f",
  measurementId: "G-8KE3TLZMFE"
};
...
const AuthScreen = ({ email, setEmail, password, setPassword, isLogin, setIsLogin, handleAuthentication }) => {
  ...
  >
    <View style={styles.container}>
      ...
      <MaterialIcons name="email" size={24} color="#63C6D0" style={styles.icon1} />
      <TextInput
        style={styles.input}
        value={email}
      ...
      />
       ...
       <View style={styles.inputContainer}>
       <MaterialIcons name="lock" size={24} color="#63C6D0" style={styles.icon1} />
        <TextInput
          style={styles.input}
          value={password}
          onChangeText={(value) => {
        ...
        <View style={styles.buttonContainer}>
          <Button title={isLogin ? 'Sign In' : 'Sign Up'} onPress={handleAuthentication} color="#63C6D0" />
        </View>
